        ...
        for i, frame_id in enumerate(frame_ids):
            ...
            for cam_idx in range(6):
                ...
                sensor_data[cam_key] = {
                    ...
                    "calibrated_sensor_token": self.token_manager.get_calibration_token(cam_key)
                }
...
def build_idd3d_to_nuscenes_pipeline(config: dict) -> DatasetConversionPipeline:
    ...
    # PHASE 4: Annotations (needs token_manager for scene_token)
    if conversions.get('annot', False):
        pipeline.add_converter(IDD3DAnnotationConverter(token_manager, sequence_name))
